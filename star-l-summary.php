...
@media only screen and (max-width: 480px) {
    ...
    <div id="summaryDisplay">
        ...
        foreach ($array as $key => $value) {
			...
			// echo "<pre>"; print_r($array1['date1']); echo "</pre>";
			if($key != 'savedata'){
            ?>
			
				<div class="col-sm-6 card_wrap">
					<div class="card_inner">
						<button class="head_btn"><?php echo $key ?></button>
						<p class="val_txt"><span>Date of Entry: <?php echo date("m/d/Y", strtotime($array1['date1'])); ?></span><br><?php echo $value ?>.</p>
					</div>
				</div>
    ...
    <div class="button_group">
        <div class="button_2">
            <a href="https://isuriz.com/STAR-L-worksheet.php">
...
<script>
    ...
    confirmBtn.onclick = function () {
        ...
        // window.location.href = 'https://isuriz.com/worksheet.php';
    };
